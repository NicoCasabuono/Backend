...
const schema = new Schema({
  ...
  //cart: { type: String, unique: null, required: false },
...
export class usersDAO  {
  ...
  async createUser(userData) {
    try {
      ...
      if (error.code === 11000 && error.keyPattern && error.keyPattern.cart) {
        throw new Error('El valor de "cart" ya existe en la colección.');
      } else {
